...
namespace AutomationExerciseFramework.Pages
{
    class SignupPage
    {
        ...
        public SignupPage(IWebDriver driver)   //ctor+tab
        {
            this._driver = driver;
            var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(15));
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(signupPage)); //u konstruktoru
            //se uvek proverava da li glavni element postoji (page)
