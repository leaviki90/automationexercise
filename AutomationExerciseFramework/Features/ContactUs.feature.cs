...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("User can send message via contact form")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public void UserCanSendMessageViaContactForm()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User can send message via contact form", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
